...
def export_to_csv(
    ...
    *,
    ...
    """Deprecated wrapper for :func:`core.export.export_optuna_results`.

    This remains for backward compatibility during the migration and will be
    removed alongside the grid search engine.
    """
