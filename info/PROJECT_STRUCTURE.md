...
│   ├── test_sanity.py               # базовый sanity-тест инфраструктуры
│   ├── test_regression_s01.py       # регрессия стратегии S_01
...
│   │   ├── s01_trailing_ma/
│   │   │   ├── __init__.py
│   │   │   ├── strategy.py          # текущая/основная реализация S_01 (после миграции)
│   │   │   └── config.json          # описание параметров/диапазонов
│   │   └── s01_trailing_ma_migrated/
│   │       ├── __init__.py
│   │       ├── strategy.py          # временная папка для мигрируемой версии S_01
│   │       └── config.json
...
- **`src/strategies/`**:
  ...
  - `s01_trailing_ma_migrated/` — временная папка для миграции S_01,
  - `s01_trailing_ma/` — основная версия S_01 после завершения миграции.
